...
class MainWindow:
    ...
    def _setup_GUI(self):
        ...
        self.lbl_instruct = ttk.Label(self.mainframe, text="Select an AuctionFlex-exported .csv file to process",
                                      anchor="center")
        ...
        self.src_button = ttk.Button(self.mainframe, text="Browse", command=self.get_source_file).grid(column=2, row=1,
                                                                                                       sticky=W)
        ...
        self.dest_path = ""
        self.proc_button = ttk.Button(self.step2_frame, text="Process", state=["disabled"], command=self.getdestfile)
        self.proc_button.grid(column=3, row=0, sticky=W)
